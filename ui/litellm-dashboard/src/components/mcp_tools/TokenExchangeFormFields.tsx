      ...
      <Form.Item
        label={
          <FieldLabel
            ...
            tooltip="RFC 8693 token endpoint. The proxy exchanges the user's incoming token here for a scoped token used to call the upstream MCP server."
          />
        }
        name="token_exchange_endpoint"
        rules={[{ required: true, message: "Token Exchange Endpoint is required for token exchange" }]}
      >
